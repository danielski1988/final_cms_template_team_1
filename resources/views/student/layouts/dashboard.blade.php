            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li>
                            <a><small><i class="fa fa-user fa-fw"></i>{{session('full_name')}}</small></a>
                            <a>&nbsp;&nbsp;<i class="fa fa-angle-double-right fa-fw"></i><small> UID - {{session('uid')}}</small></a>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li {{ (Request::is('/student/home') ? 'class="active"' : '') }}>
                            <a href="{{ url ('/student/home') }}"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                        </li>

                        <li >
                            <a href="#"><i class="fa  fa-user fa-fw "></i> Personal<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li {{ (Request::is('/student/myattendance') ? 'class="active"' : '') }}>
                                    <a href="{{ url ('/student/myattendance' ) }}"><i class="fa fa-pencil-square-o"></i> My Attendance</a>
                                </li>
                            </ul>
                        ...
                        <li >
                            <a href="{{ url ('/student/mentor') }}"><i class="fa  fa-user fa-fw "></i><Placeholder> My Mentor</Placeholder></span></a>
                        </li>
